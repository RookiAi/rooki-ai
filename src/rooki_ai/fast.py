...
from rooki_ai.utils.update_voice_config_in_supabase import update_voice_config_in_supabase
    ...
    # Construct inputs for the crew
        ...
        try:
                    ...
                    if not update_success:
                        logger.warning(f"Failed to update voice config in Supabase for {request.x_handle}")
