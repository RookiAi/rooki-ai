...
class SuperbaseGetVoiceTool(BaseTool):
    ...
    name: str = "SupabaseUserVoiceStorageUrlTool"
    ...
    def _run(self, user_id: str) -> str:
        ...
        Returns:
            The storage URL for the given user_id
        Raises:
        ...
        try:
            ...
            query = 'SELECT storage_url FROM public."Voice" WHERE user_id = %s'
    ...
    async def _arun(self, user_id: str) -> str:
        ...
        try:
            ...
            # Query the voice table for the storage_url (lowercase table name)
            query = 'SELECT storage_url FROM public."Voice" WHERE user_id = $1'
            ...
            print(f"Successfully retrieved storage_url for {user_id} (async)")
            return result
